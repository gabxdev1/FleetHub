...
public class GlobalErrorHandlerAdvice {
    ...
    public ResponseEntity<ApiError> handleForbiddenException(final BadCredentialsException ex, final HttpServletRequest request) {
        return prepareResponse(HttpStatus.UNAUTHORIZED, request, ex.getMessage());
    }
